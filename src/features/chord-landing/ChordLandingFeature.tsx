...
const APPROACHES: Approach[] = [
  ...
  },
  {
    ...
    theory: 'Il tritono sub di G7 (Db7) risolve a G7 poi a I. Db7 scende cromaticamente verso G (Db→C mezzo tono, Ab→G mezzo tono) — doppia risoluzione cromatica. Bass line: Db → G → C — salto di tritono poi quarta perfetta. (Mulholland/Hojnacki cap. 3 — Substitute Dominants)',
