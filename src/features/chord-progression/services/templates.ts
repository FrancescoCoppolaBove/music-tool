...
export const TEMPLATES: ProgressionTemplate[] = [
  ...
  {
    id: 'dorian-IV7-bVII-float',
    name: 'IV7–♭VII (Dorian Color Float)',
    chords: [
      { degree: 'IV',   quality: '7',   function: 'Color', technique: 'diatonic', annotation: 'IV7 — the defining Dorian chord; never returns to tonic' },
      { degree: 'bVII', quality: 'maj7',function: 'Color', technique: 'diatonic', annotation: '♭VII — natural minor color; together these confirm the mode without Im' },
    ],
    style: 'classic', techniques: ['diatonic'],
    description: 'The two most characteristic non-tonic Dorian chords — IV7 and ♭VII — side by side without touching Im. The Dorian sound floating free of its tonic anchor.',
    artists: ['Miles Davis', 'Herbie Hancock', 'Roy Ayers', 'Erykah Badu'],
    feel: 'Tonic-free Dorian float',
    lengths: [2],
    mode: 'dorian',
  },
  {
    id: 'dorian-IIm7-IV7-no-tonic',
    name: 'IIm7–IV7 (Dorian Non-Tonic Ascent)',
    chords: [
      { degree: 'II',  quality: 'm7',function: 'Subdominant', technique: 'diatonic' },
      { degree: 'IV',  quality: '7', function: 'Color',       technique: 'diatonic', annotation: 'IV7 — Dorian characteristic; arriving here without a tonic makes the mode float' },
    ],
    style: 'modern', techniques: ['diatonic'],
    description: 'Opens on IIm7 and rises to IV7 — the Dorian color without ever touching the tonic. A modal two-chord that defines the mode through color alone.',
    artists: ['Robert Glasper', 'Avishai Cohen', 'Alfa Mist', 'GoGo Penguin'],
    feel: 'Modal Dorian non-tonic float',
    lengths: [2],
    mode: 'dorian',
  },
  {
  ...
  {
    id: 'phrygian-bII-bIII-no-tonic',
    name: '♭II–♭III (Phrygian Upper Pair)',
    chords: [
      { degree: 'bII',  quality: 'maj7',function: 'Color', technique: 'diatonic', annotation: '♭II — the Phrygian marker; ascending to ♭III without touching im' },
      { degree: 'bIII', quality: 'maj7',function: 'Color', technique: 'diatonic', annotation: '♭III — whole-step above ♭II; both major, no tonic' },
    ],
    style: 'classic', techniques: ['diatonic'],
    description: 'Two consecutive major chords from Phrygian — ♭II ascending a whole step to ♭III — without the tonic. A floating Phrygian pair heard in metal riffs and flamenco falsetas.',
    artists: ['Meshuggah', 'Gojira', 'Tool', 'Paco de Lucía'],
    feel: 'Phrygian upper-pair float — no tonic',
    lengths: [2],
    mode: 'phrygian',
  },
  {
    id: 'phrygian-bVI-bVII-no-tonic',
    name: '♭VI–♭VII (Phrygian Tail)',
    chords: [
      { degree: 'bVI',  quality: 'maj7',function: 'Color', technique: 'diatonic', annotation: '♭VI — distant major color in Phrygian' },
      { degree: 'bVII', quality: 'm7',  function: 'Color', technique: 'diatonic', annotation: '♭VII — minor 7th in Phrygian; together an exotic pair with no tonic' },
    ],
    style: 'modern', techniques: ['diatonic'],
    description: 'The upper pair of Phrygian — ♭VI (major) to ♭VII (minor) — completely avoids the tonic. Creates an exotic, floating quality particular to the Phrygian mode.',
    artists: ['Tigran Hamasyan', 'Anouar Brahem', 'Omar Sosa', 'Avishai Cohen'],
    feel: 'Exotic Phrygian upper float',
    lengths: [2],
    mode: 'phrygian',
  },
  {
  ...
  {
    id: 'lydian-Vmaj7-II7-no-tonic',
    name: 'Vmaj7–II7 (Lydian Dual Non-Tonic)',
    chords: [
      { degree: 'V',  quality: 'maj7',function: 'Color', technique: 'diatonic', annotation: 'Vmaj7 — in Lydian the V is major 7 (not dominant), a unique warm color' },
      { degree: 'II', quality: '7',   function: 'Color', technique: 'diatonic', annotation: 'II7 — Lydian characteristic: the tritone-color dominant' },
    ],
    style: 'modern', techniques: ['diatonic'],
    description: 'Vmaj7 descends a fourth to the characteristic II7 — two non-tonic Lydian chords. The Vmaj7→II7 whole-step drop confirms the Lydian scale without touching Imaj7.',
    artists: ['Steve Vai', 'Joe Satriani', 'Pat Metheny', 'Kurt Rosenwinkel'],
    feel: 'Lydian color without tonic anchor',
    lengths: [2],
    mode: 'lydian',
  },
  {
    id: 'lydian-III-VI-no-tonic',
    name: 'IIIm7–VIm7 (Lydian Inner Pair)',
    chords: [
      { degree: 'III', quality: 'm7',function: 'Color', technique: 'diatonic' },
      { degree: 'VI',  quality: 'm7',function: 'Color', technique: 'diatonic', annotation: 'VIm7 — descending a fifth from IIIm7; quiet inner Lydian color' },
    ],
    style: 'modern', techniques: ['diatonic'],
    description: 'Two inner minor chords in the Lydian mode — IIIm7 stepping down a fifth to VIm7 — no tonic, no tritone. Quiet and contemplative, the inner color of Lydian without its drama.',
    artists: ['Bill Evans', 'Keith Jarrett', 'Chick Corea', 'Brad Mehldau'],
    feel: 'Lydian inner minor hover',
    lengths: [2],
    mode: 'lydian',
  },
  {
  ...
  {
    id: 'mixo-IV-bVII-no-tonic',
    name: 'IV–♭VII (Mixolydian Power Duo)',
    chords: [
      { degree: 'IV',   quality: 'maj7',function: 'Color', technique: 'diatonic' },
      { degree: 'bVII', quality: 'maj7',function: 'Color', technique: 'diatonic', annotation: '♭VII — the Mixolydian badge: major chord a whole step below tonic' },
    ],
    style: 'classic', techniques: ['diatonic'],
    description: 'IV and ♭VII — the two defining Mixolydian chords — without the dominant tonic I7. The backbone of "Sweet Home Alabama", "Brown Eyed Girl", and Celtic folk. Endlessly loopable.',
    artists: ['Lynyrd Skynyrd', 'Van Morrison', 'The Allman Brothers', 'ZZ Top'],
    feel: 'Classic rock Mixolydian endless loop',
    lengths: [2],
    mode: 'mixolydian',
  },
  {
    id: 'mixo-IIm7-bVII-no-tonic',
    name: 'IIm7–♭VII (Mixolydian Non-Tonic Float)',
    chords: [
      { degree: 'II',   quality: 'm7',  function: 'Color', technique: 'diatonic' },
      { degree: 'bVII', quality: 'maj7',function: 'Color', technique: 'diatonic', annotation: '♭VII — Mixolydian color; together IIm7+♭VII confirm the mode with no I7' },
    ],
    style: 'modern', techniques: ['diatonic'],
    description: 'IIm7 rising to the ♭VII — two non-tonic Mixolydian chords that float without the dominant I7. Perfect for modal grooves that want Mixolydian color without an overt dominant tonic.',
    artists: ['Snarky Puppy', 'Trombone Shorty', 'Cory Henry', 'Galactic'],
    feel: 'Mixolydian non-tonic modal groove',
    lengths: [2],
    mode: 'mixolydian',
  },
  {
    id: 'mixo-Vm7-IV-no-tonic',
    name: 'Vm7–IV (Mixolydian Minor-V)',
    chords: [
      { degree: 'V',  quality: 'm7',  function: 'Color', technique: 'diatonic', annotation: 'Vm7 — in Mixolydian the V is minor (no leading tone): the mode\'s floating quality' },
      { degree: 'IV', quality: 'maj7',function: 'Color', technique: 'diatonic' },
    ],
    style: 'modern', techniques: ['diatonic'],
    description: 'Vm7 descending to IVmaj7 in Mixolydian — the minor V is a key signal of the mode (no leading tone). Music floats rather than pulls. Celtic, modal rock, and Sting territory.',
    artists: ['The Beatles', 'Led Zeppelin', 'Sting', 'Carlos Santana'],
    feel: 'Modal Mixolydian — minor V descent',
    lengths: [2],
    mode: 'mixolydian',
  },
  {
  ...
  {
    id: 'phrydom-bII-bVI-no-tonic',
    name: '♭II–♭VI (Phrygian Dom. Upper Pair)',
    chords: [
      { degree: 'bII', quality: 'maj7',function: 'Color', technique: 'diatonic', annotation: '♭II — the Phrygian dominant marker above the exotic tonic' },
      { degree: 'bVI', quality: 'maj7',function: 'Color', technique: 'diatonic', annotation: '♭VI — the other major chord; two consecutive majors, no I7 tonic' },
    ],
    style: 'modern', techniques: ['diatonic'],
    description: 'Two upper major chords of Phrygian Dominant — ♭II and ♭VI — with no tonic I7. Creates an exotic floating quality used in Middle Eastern film scores and modal jazz.',
    artists: ['John Williams', 'Ennio Morricone', 'Hans Zimmer', 'Tigran Hamasyan'],
    feel: 'Exotic Middle-Eastern float — no tonic',
    lengths: [2],
    mode: 'phrygian_dominant',
  },
  {
    id: 'phrydom-bVI-bVII-no-tonic',
    name: '♭VI–♭VII (Phrygian Dom. Color Pair)',
    chords: [
      { degree: 'bVI',  quality: 'maj7',function: 'Color', technique: 'diatonic' },
      { degree: 'bVII', quality: 'm7',  function: 'Color', technique: 'diatonic', annotation: '♭VII — minor in Phrygian Dom.; the pair creates exotic color with no tonic I7' },
    ],
    style: 'modern', techniques: ['diatonic'],
    description: 'Upper Phrygian Dominant color pair — ♭VI (major) to ♭VII (minor) — without the exotic dominant tonic I7. Used in Middle Eastern and film composition for floating tension.',
    artists: ['Omar Faruk Tekbilek', 'Anouar Brahem', 'Rabih Abou-Khalil', 'Hans Zimmer'],
    feel: 'Phrygian Dom. upper color — no anchor',
    lengths: [2],
    mode: 'phrygian_dominant',
  },
  {
  ...
  {
    id: 'lyddom-Vmaj7-VIm7-no-tonic',
    name: 'Vmaj7–VIm7 (Lydian Dom. Inner Float)',
    chords: [
      { degree: 'V',  quality: 'maj7',function: 'Color', technique: 'diatonic', annotation: 'Vmaj7 — major V in Lydian Dom. (contrast to the two dominants I7 and II7)' },
      { degree: 'VI', quality: 'm7',  function: 'Color', technique: 'diatonic', annotation: 'VIm7 — minor rest point; no tonic or characteristic II7' },
    ],
    style: 'modern', techniques: ['diatonic'],
    description: 'Two inner non-dominant chords of Lydian Dominant — Vmaj7 to VIm7 — without touching I7 or II7. A quieter, introspective Lydian Dom. color.',
    artists: ['Wayne Shorter', 'Herbie Hancock', 'Chick Corea', 'Tigran Hamasyan'],
    feel: 'Lydian Dom. quiet inner float',
    lengths: [2],
    mode: 'lydian_dominant',
  },
  {
    id: 'lyddom-II7-VIm7-no-tonic',
    name: 'II7–VIm7 (Lydian Dom. Characteristic Pair)',
    chords: [
      { degree: 'II', quality: '7',  function: 'Color', technique: 'diatonic', annotation: 'II7 — the upper dominant; the characteristic Lydian Dom. color chord' },
      { degree: 'VI', quality: 'm7', function: 'Color', technique: 'diatonic', annotation: 'VIm7 — minor rest point; the pair has no tonic I7' },
    ],
    style: 'modern', techniques: ['diatonic'],
    description: 'Opens on the characteristic II7 and lands on VIm7 — no tonic I7. The II7 declares the Lydian Dominant mode; VIm7 provides a minor rest. Snarky Puppy and fusion territory.',
    artists: ['Snarky Puppy', 'Tigran Hamasyan', 'Nir Felder', 'Lionel Loueke'],
    feel: 'Lydian Dom. tonic-free fusion pair',
    lengths: [2],
    mode: 'lydian_dominant',
  },
  {
  ...
  {
    id: 'two-V-IV',
    name: 'V–IV (Reverse Cadence)',
    chords: [
      { degree: 'V',  quality: '7',    function: 'Dominant',    technique: 'diatonic' },
      { degree: 'IV', quality: 'maj7', function: 'Subdominant', technique: 'diatonic' },
    ],
    style: 'classic', techniques: ['diatonic'],
    description: 'Dominant moving to subdominant — the opposite of a perfect cadence. Suspended between tension and warmth without landing on tonic. "Hey Joe" (Jimi Hendrix) and classic rock staple.',
    artists: ['Jimi Hendrix', 'Led Zeppelin', 'The Who', 'Neil Young'],
    feel: 'Classic rock reverse cadence',
    lengths: [2],
  },
  {
    id: 'two-III-VI',
    name: 'III–VI (Inner Minor Descent)',
    chords: [
      { degree: 'III', quality: 'm7', function: 'Tonic',  technique: 'diatonic', annotation: 'IIIm7 — tonic substitute, steps down a fourth' },
      { degree: 'VI',  quality: 'm7', function: 'Tonic',  technique: 'diatonic', annotation: 'VIm7 — relative minor; no I in sight' },
    ],
    style: 'modern', techniques: ['diatonic'],
    description: 'Two descending minor chords — IIIm7 to VIm7 — with no tonic. Pure inner-voice motion, evocative and wistful. Neo-soul and modern jazz territory where the tonic is deliberately avoided.',
    artists: ['Robert Glasper', 'D\'Angelo', 'Tom Misch', 'Alfa Mist'],
    feel: 'Wistful inner-minor descent',
    lengths: [2],
  },
  {
    id: 'two-II-III',
    name: 'II–III (Inner Stepwise Ascent)',
    chords: [
      { degree: 'II',  quality: 'm7', function: 'Subdominant', technique: 'diatonic' },
      { degree: 'III', quality: 'm7', function: 'Tonic',       technique: 'diatonic', annotation: 'IIIm7 — whole-step rise; both minor, no I' },
    ],
    style: 'modern', techniques: ['diatonic'],
    description: 'Two adjacent inner minor chords — IIm7 stepping up a whole tone to IIIm7 — no tonic, no dominant. Minimal and floating, common in jazz comping and neo-soul vamps.',
    artists: ['Steely Dan', 'Pat Metheny', 'Brad Mehldau', 'Kiefer'],
    feel: 'Floating minor stepwise lift',
    lengths: [2],
  },
  ...
  {
    id: 'minor-bVI-bVII-no-tonic',
    name: '♭VI–♭VII (Aeolian Ascending Pair)',
    chords: [
      { degree: 'bVI',  quality: 'maj7', function: 'Subdominant', technique: 'diatonic' },
      { degree: 'bVII', quality: 'maj7', function: 'Color',       technique: 'diatonic', annotation: '♭VII — ascending from ♭VI; both major, no tonic' },
    ],
    style: 'classic', techniques: ['diatonic'],
    description: 'The ascending Aeolian major-chord pair without the tonic — ♭VI to ♭VII. The backbone of rock anthems and film crescendos. Two major chords, zero tonic, maximum tension.',
    artists: ['Led Zeppelin', 'Eagles', 'Pink Floyd', 'Radiohead'],
    feel: 'Anthemic Aeolian ascending build',
    lengths: [2],
    mode: 'minor',
  },
  {
    id: 'minor-bVII-bVI-no-tonic',
    name: '♭VII–♭VI (Aeolian Descending Pair)',
    chords: [
      { degree: 'bVII', quality: 'maj7', function: 'Color',       technique: 'diatonic' },
      { degree: 'bVI',  quality: 'maj7', function: 'Subdominant', technique: 'diatonic', annotation: '♭VI — descending; no tonic, purely coloristic' },
    ],
    style: 'classic', techniques: ['diatonic'],
    description: 'Descending Aeolian major-chord pair without the tonic — ♭VII to ♭VI. Dark, cinematic, and melancholic. The descending bass creates gravitas without resolving to im.',
    artists: ['Portishead', 'Massive Attack', 'Radiohead', 'Ólafur Arnalds'],
    feel: 'Cinematic dark descent — no tonic',
    lengths: [2],
    mode: 'minor',
  },
  {
    id: 'minor-IIm7b5-V7b9-hang',
    name: 'IIm7♭5–V7♭9 (Open Minor ii-V)',
    chords: [
      { degree: 'II', quality: 'm7b5', function: 'Subdominant', technique: 'diatonic', annotation: 'iim7♭5 — half-diminished, natural minor ii' },
      { degree: 'V',  quality: '7b9',  function: 'Dominant',    technique: 'diatonic', annotation: 'V7♭9 — harmonic minor dominant; im never arrives' },
    ],
    style: 'modern', techniques: ['diatonic'],
    description: 'The minor ii–V hanging without resolution — maximum tension with no tonic landing. Infinitely loopable. Bill Evans, Miles Davis, and every jazz minor ballad intro.',
    artists: ['Bill Evans', 'Miles Davis', 'Ahmad Jamal', 'Brad Mehldau'],
    feel: 'Hanging minor ii-V — jazz tension loop',
    lengths: [2],
    mode: 'minor',
  },
  {
    id: 'minor-bIII-bVII-float',
    name: '♭III–♭VII (Minor Color Pair)',
    chords: [
      { degree: 'bIII', quality: 'maj7', function: 'Color', technique: 'diatonic' },
      { degree: 'bVII', quality: 'maj7', function: 'Color', technique: 'diatonic', annotation: '♭VII — two of the most open-sounding major chords in natural minor, no tonic' },
    ],
    style: 'modern', techniques: ['diatonic'],
    description: 'Two major chords from natural minor — ♭III and ♭VII — without touching the tonic. Floating, atmospheric, melancholic. Film scores and atmospheric electronica territory.',
    artists: ['Hans Zimmer', 'Nils Frahm', 'Ólafur Arnalds', 'Burial'],
    feel: 'Atmospheric minor major-chord float',
    lengths: [2],
    mode: 'minor',
  },
  {
    id: 'minor-IV-bVII-no-tonic',
    name: 'IVm7–♭VII (Minor Subdominant Float)',
    chords: [
      { degree: 'IV',   quality: 'm7',  function: 'Subdominant', technique: 'diatonic' },
      { degree: 'bVII', quality: 'maj7',function: 'Color',       technique: 'diatonic', annotation: '♭VII — ascends from iv minor; no tonic in this pair' },
    ],
    style: 'modern', techniques: ['diatonic'],
    description: 'Minor iv rising to the major ♭VII — both from natural minor, no tonic. Creates a floating, unresolved quality that loops effortlessly. Common in soul, hip-hop, and modern jazz.',
    artists: ['Erykah Badu', 'Anderson .Paak', 'Thundercat', 'Karriem Riggins'],
    feel: 'Minor subdominant float — no anchor',
    lengths: [2],
    mode: 'minor',
  },
  {
  ...
  // ─── Theory additions ─────────────────────────────────────────────────────────
  {
    ...
    chords: [
      { degree: 'II',  quality: 'm7',   function: 'Subdominant', technique: 'diatonic', annotation: 'IIm7 — diatonic preparation' },
      { degree: 'bII', quality: 'maj7', function: 'Subdominant', technique: 'tritone_sub', annotation: '♭IImaj7 — Neapolitan chord: ♭II major as pre-dominant substitution for IV', techniqueLabel: 'Neapolitan' },
      { degree: 'V',   quality: '7',    function: 'Dominant',    technique: 'diatonic', annotation: 'V7 — half-step bass resolution from ♭II to V' },
      { degree: 'I',   quality: 'maj7', function: 'Tonic',       technique: 'diatonic' },
    ],
    style: 'classic', techniques: ['tritone_sub', 'diatonic'],
    description: 'The Neapolitan chord (♭IImaj7) as pre-dominant in major key. The ♭II substitutes for IV and creates a characteristic half-step bass descent ♭II→V→I. Core of classical harmony (Schubert, Chopin) and jazz ballads (Bill Evans, Keith Jarrett).',
    artists: ['Bill Evans', 'Keith Jarrett', 'Chopin', 'Schubert'],
    feel: 'Classical / Jazz — Neapolitan pre-dominant',
    lengths: [4],
  },
  {
    id: 'andalusian-full-loop',
    name: 'im7–♭VII7–♭VImaj7–V7♭9–im7 (Full Andalusian Loop)',
    chords: [
      { degree: 'I',   quality: 'm7',   function: 'Tonic',       technique: 'diatonic' },
      { degree: 'bVII',quality: '7',    function: 'Color',       technique: 'flamenco', annotation: '♭VII7 — first step of the Andalusian descent', techniqueLabel: 'Andalusian Descent' },
      { degree: 'bVI', quality: 'maj7', function: 'Color',       technique: 'flamenco', annotation: '♭VImaj7 — second step, characteristic Andalusian color', techniqueLabel: 'Andalusian Descent' },
      { degree: 'V',   quality: '7b9',  function: 'Dominant',    technique: 'flamenco', annotation: 'V7♭9 — Phrygian dominant: raised leading tone from harmonic minor + ♭9 tension', techniqueLabel: 'Phrygian Dominant' },
      { degree: 'I',   quality: 'm7',   function: 'Tonic',       technique: 'diatonic' },
    ],
    style: 'classic', techniques: ['flamenco', 'diatonic'],
    description: 'The complete Andalusian tetrachord i–♭VII–♭VI–V, returning to tonic — the defining sound of flamenco, Spanish classical, and Middle Eastern music. The V7♭9 (Phrygian dominant) drives back to im with maximum tension. Paco de Lucía, Camarón, Rodrigo, Massenet.',
    artists: ['Paco de Lucía', 'John McLaughlin', 'Al Di Meola', 'Camarón de la Isla'],
    feel: 'Flamenco — full Andalusian descent and return',
    lengths: [5],
    mode: 'minor',
  },
  {
    id: 'deceptive-cadence-rebuild',
    name: 'V7–VIm7–IVmaj7–IIm7–V7–Imaj7 (Deceptive Cadence → Rebuild)',
    chords: [
      { degree: 'V',   quality: '7',    function: 'Dominant',    technique: 'diatonic', annotation: 'V7 — sets up expectation of I resolution' },
      { degree: 'VI',  quality: 'm7',   function: 'Tonic',       technique: 'diatonic', annotation: 'VIm7 — deceptive resolution: V→vi instead of V→I (Berklee: "interrupted cadence")', techniqueLabel: 'Deceptive Cadence' },
      { degree: 'IV',  quality: 'maj7', function: 'Subdominant', technique: 'diatonic', annotation: 'IVmaj7 — rebuilds subdominant tension after deception' },
      { degree: 'II',  quality: 'm7',   function: 'Subdominant', technique: 'diatonic', annotation: 'IIm7 — ii pre-dominant before the final V7' },
      { degree: 'V',   quality: '7',    function: 'Dominant',    technique: 'diatonic', annotation: 'V7 — authentic cadence, now earned after the rebuild' },
      { degree: 'I',   quality: 'maj7', function: 'Tonic',       technique: 'diatonic' },
    ],
    style: 'classic', techniques: ['diatonic'],
    description: 'Berklee deceptive (interrupted) cadence: V7 resolves to vi instead of I, then rebuilds subdominant tension through IV→II before reaching V7→I. The full-phrase arc — expectation, surprise, rebuilding, resolution — is the defining feature of classical phrasing and film music.',
    artists: ['Johann Sebastian Bach', 'Beethoven', 'John Williams', 'Bernard Herrmann'],
    feel: 'Classical — deceptive cadence and full rebuild',
    lengths: [6],
  },
