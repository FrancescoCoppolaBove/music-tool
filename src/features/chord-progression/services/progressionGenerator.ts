...
export function getAvailableTechniques(): { id: Technique; label: string; description: string }[] {
  return [
    ...
    { id: 'chromatic',         label: 'Chromatic / Dim Vamp',  description: 'Chromatic passing chords and mediant motion (e.g. I → ♯Idim → IIm).' },
    ...
    { id: 'modulation',        label: 'Modulation',            description: 'Pivot chord or direct modulation to a new key within the progression.' },
    ...
    { id: 'blues',             label: 'Blues',                  description: 'Blues form: dominant seventh chords on I7, IV7, V7. 12-bar, 8-bar, jazz blues, minor blues — the root of jazz, rock, and soul.' },
    { id: 'gospel',            label: 'Gospel',                 description: 'Gospel harmony: plagal cadence IV→I, secondary dominant chains, chromatic ♭II°7. The sound of Kirk Franklin, Aretha, Sam Cooke.' },
