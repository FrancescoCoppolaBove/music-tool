...
export function ChordsExercise() {
  ...
  const generateQuestion = useCallback(() => {
    ...
    const question = generateRandomChord(difficulty as ChordDifficulty, inversionsArray);
  ...
  return (
    <div className='exercise-container'>
      ...
      <div className='exercise-playback'>
        <button className={`play-button ${isPlaying ? 'playing' : ''}`} onClick={playChord} disabled={isPlaying}>
          <Volume2 size={32} />
